...
! function(n, e) {
    ...
    var n = {
        ...
        _lktAnimationTargetRef = undefined,
        _lktAnimationValue = undefined,
        _lktAnimationEasing = 'linear'
        ;
    ...
    function rn(r) {
        ...
        var l, d, p, h, v, g, y, b, M = (d = w(n, l = r), p = w(e, l), h = z(p, l), v = Q(l.targets), g = W(v, h), y = J(g, p), b = K, K++, k(d, {
            ...
            delay: y.delay,
            endDelay: y.endDelay, 
            lkt:_lktAnimationTargetRef//Important to set it at the end : Otherwise throw error
        }));
        f(M);
    ...
    return "undefined" != typeof document && document.addEventListener("visibilitychange", function() {
        ...
        return r.duration = 0, r.add = function(t, a) {
            var o = _.indexOf(r),
                u = r.children;
            _lktAnimationTargetRef = t.targets;
            // console.log(t)
            _lktAnimationValue =  t[Object.keys(t)[1]].value;
            _lktAnimationEasing = t[Object.keys(t)[1]].easing ;
